...
<html lang="en">
	<head>
		<meta charset="UTF-8" />
		<meta name="title" content="Handly" />
		<meta name="description" content="This Website Build for ICT 2021" />
					...
					<div class="wrapper js-header-wrapper">
						<div class="header__logo">
							<a href="/">
								<img
									class="header__logo"
									id="logo_js"
									src="https://raroin.creabik.com/assets/img/logos/Logo.svg"
									alt="logo"
									/>
							</a>
						</div>
						...
						<div class="header__menu">
							<ul class="d-flex space-x-20">
								<li class="has_popup">
									<a class="color_black" href="#">Dashboards <i class="ri-more-2-fill"></i></a>
									<ul class="menu__popup space-y-20">
										...
										<li>
											<a href="Dashboard2.html">
												<i class="ri-home-2-line"></i> Dashboard page 2</a>
										</li>
										<li>
											<a href="Dashboard3.html">
												<i class="ri-home-5-line"></i> Dashboard page 3</a>
										</li>
									</ul>
								</li>
								<li>
						...
						<div class="header__btns">
                            @auth
                                <a href="{{ url('/dashboard') }}" id="connectbtn">
                                    <img width="45" src="https://raroin.creabik.com/assets/img/icons/metamask.svg" alt="">
                                </a>
                            @else
                                <a href="{{ route('login') }}" class="btn btn-grad btn-sm" href="Connect-wallet.html">Login</a>

                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="btn btn-grad btn-sm" href="Connect-wallet.html">Register</a>
                                @endif
                            @endauth
					...
					<div class="wrapper js-header-wrapper space-x-10">
						...
						<div class="d-flex align-items-center space-x-20">
							<div class="header__notifications">
								...
								<div class="notifications_popup space-y-20">
									...
									<div
										...
										<img
											class="thumb"
											src="https://raroin.creabik.com/assets/img/notifications/1.png"
											alt="..."
											/>
										<div class="details">
							...
							<div class="header__avatar">
								...
								<img
									class="avatar"
									src="https://raroin.creabik.com/assets/img/avatars/avatar_2.png"
									alt="avatar"
									/>
								<div class="avatar_popup space-y-20">
									...
									<div class="d-flex align-items-center space-x-10">
										<img
											class="coin"
											src="https://raroin.creabik.com/assets/img/logos/coin.svg"
											alt="/"
											/>
										<div class="info">
						...
						<div class="row align-items-center">
							...
							<div class="col-lg-6">
								<img class="img-fluid w-full" id="img_js"
									src="https://raroin.creabik.com/assets/img/bg/in_hero1.png"
									alt="">
							</div>
						</div>
									...
									<div class="swiper-slide">
										<div class="creator_item creator_card rounded_border space-x-10">
											<div class="avatars space-x-10">
												<div class="media">
													<div class="badge">
														<img src="https://raroin.creabik.com/assets/img/icons/Badge.svg" alt="" />
													</div>
													<a href="Profile.html">
														<img
															src="https://raroin.creabik.com/assets/img/avatars/avatar_1.png"
															alt="Avatar"
										...
										<div class="creator_item creator_card rounded_border space-x-10">
											<div class="avatars space-x-10">
												<div class="media">
													...
													<a href="Profile.html">
														<img
															src="https://raroin.creabik.com/assets/img/avatars/avatar_3.png"
															alt="Avatar"
															class="avatar avatar-md"
														/>
													</a>
										...
										<div class="creator_item creator_card rounded_border space-x-10">
											<div class="avatars space-x-10">
												<div class="media">
													...
													<a href="Profile.html">
														<img
															src="https://raroin.creabik.com/assets/img/avatars/avatar_4.png"
															alt="Avatar"
															class="avatar avatar-md"
														/>
													</a>
										...
										<div class="creator_item creator_card rounded_border space-x-10">
											<div class="avatars space-x-10">
												<div class="media">
													...
													<a href="Profile.html">
														<img
															src="https://raroin.creabik.com/assets/img/avatars/avatar_5.png"
															alt="Avatar"
															class="avatar avatar-md"
														/>
													</a>
						...
						<div class="modal-body space-y-20 p-40">
							...
							<div class="creator_item creator_card space-x-10">
								<div class="avatars space-x-10">
									<div class="media">
										<div class="badge">
											<img src="https://raroin.creabik.com/assets/img/icons/Badge.svg"
												alt="">
										</div>
										<a href="Profile.html">
											<img
							...
							<div class="card__item four">
								<div class="card_body space-y-10">
									...
									<div class="card_head">
										<a href="Item-details.html">
											<img
												src="https://raroin.creabik.com/assets/img/items/item_1.png"
												alt="item
												img" />
										</a>
								...
								<div class="card_body space-y-10">
									...
									<div class="creators space-x-10">
										...
										<div class="avatars space-x-3">
											<a href="Profile.html">
												<img
													src="https://raroin.creabik.com/assets/img/avatars/avatar_6.png"
													alt="Avatar"
													class="avatar avatar-sm" />
											</a>
											<a href="Profile.html">
									...
									<div class="card_head">
										<a href="Item-details.html">
											<img
												src="https://raroin.creabik.com/assets/img/items/item_3.png"
												alt="item
												img" />
										</a>
										<a href="#" class="likes space-x-3">
								...
								<div class="card_body space-y-10">
									...
									<div class="creators space-x-10">
										...
										<div class="avatars space-x-3">
											<a href="Profile.html">
												<img
													src="https://raroin.creabik.com/assets/img/avatars/avatar_7.png"
													alt="Avatar"
													class="avatar avatar-sm" />
											</a>
											<a href="Profile.html">
								...
								<div class="card_body space-y-10">
									...
									<div class="creators space-x-10">
										<div class="avatars space-x-3">
											<a href="Profile.html">
												<img
													src="https://raroin.creabik.com/assets/img/avatars/avatar_8.png"
													alt="Avatar"
													class="avatar avatar-sm" />
											</a>
											<a href="Profile.html">
										...
										<div class="avatars space-x-3">
											<a href="Profile.html">
												<img
													src="https://raroin.creabik.com/assets/img/avatars/avatar_9.png"
													alt="Avatar"
													class="avatar avatar-sm" />
											</a>
											<a href="Profile.html">
									...
									<div class="card_head">
										<a href="Item-details.html">
											<img
												src="https://raroin.creabik.com/assets/img/items/item_5.png"
												alt="item
												img" />
										</a>
										<a href="#" class="likes space-x-3">
								...
								<div class="card_body space-y-10">
									...
									<div class="creators space-x-10">
										<div class="avatars space-x-3">
											<a href="Profile.html">
												<img
													src="https://raroin.creabik.com/assets/img/avatars/avatar_10.png"
													alt="Avatar"
													class="avatar avatar-sm" />
											</a>
											<a href="Profile.html">
										...
										<div class="avatars space-x-3">
											<a href="Profile.html">
												<img
													src="https://raroin.creabik.com/assets/img/avatars/avatar_11.png"
													alt="Avatar"
													class="avatar avatar-sm" />
											</a>
											<a href="Profile.html">
									...
									<div class="card_head">
										<a href="Item-details.html">
											<img
												src="https://raroin.creabik.com/assets/img/items/item_6.png"
												alt="item
												img" />
										</a>
										<a href="#" class="likes space-x-3">
							...
							<div class="card__item four">
								<div class="card_body space-y-10">
									...
									<div class="card_head">
										<a href="Item-details.html">
											<img
												src="https://raroin.creabik.com/assets/img/items/item_7.png"
												alt="item
												img" />
										</a>
										<a href="#" class="likes space-x-3">
								...
								<div class="card_body space-y-10">
									...
									<div class="creators space-x-10">
										<div class="avatars space-x-3">
											<a href="Profile.html">
												<img
													src="https://raroin.creabik.com/assets/img/avatars/avatar_13.png"
													alt="Avatar"
													class="avatar avatar-sm" />
											</a>
											<a href="Profile.html">
										...
										<div class="avatars space-x-3">
											<a href="Profile.html">
												<img
													src="https://raroin.creabik.com/assets/img/avatars/avatar_14.png"
													alt="Avatar"
													class="avatar avatar-sm" />
											</a>
											<a href="Profile.html">
									...
									<div class="card_head">
										<a href="Item-details.html">
											<img
												src="https://raroin.creabik.com/assets/img/items/item_8.png"
												alt="item
												img" />
										</a>
										<a href="#" class="likes space-x-3">
			        			...
			        			<a href="collections.html">
			        				<div class="collections_item">
			        					<div class="images-box space-y-10">
			        						<div class="top_imgs">
			        							<img
			        								src="https://raroin.creabik.com/assets/img/items/item_9.png"
			        								alt="">
			        							<img
			        								src="https://raroin.creabik.com/assets/img/items/item_10.png"
			        								alt="">
			        							<img
			        								src="https://raroin.creabik.com/assets/img/items/item_11.png"
			        								alt="">
			        						</div>
			        						<img src="https://raroin.creabik.com/assets/img/items/item_12.png"
			        							alt="">
			        					</div>
			        				</div>
			        			</a>
			        			...
			        			<a href="collections.html">
			        				<div class="collections_item">
			        					<div class="images-box space-y-10">
			        						<div class="top_imgs">
			        							<img
			        								src="https://raroin.creabik.com/assets/img/items/item_13.png"
			        								alt="">
			        							<img
			        								src="https://raroin.creabik.com/assets/img/items/item_14.png"
			        								alt="">
			        							<img
			        								src="https://raroin.creabik.com/assets/img/items/item_15.png"
			        								alt="">
			        						</div>
			        						<img src="https://raroin.creabik.com/assets/img/items/item_16.png"
			        							alt="">
			        					</div>
			        				</div>
			        			</a>
			        			...
			        			<a href="collections.html">
			        				<div class="collections_item">
			        					<div class="images-box space-y-10">
			        						<div class="top_imgs">
			        							<img
			        								src="https://raroin.creabik.com/assets/img/items/item_17.png"
			        								alt="">
			        							<img
			        								src="https://raroin.creabik.com/assets/img/items/item_18.png"
			        								alt="">
			        							<img
			        								src="https://raroin.creabik.com/assets/img/items/item_19.png"
			        								alt="">
			        						</div>
			        						<img src="https://raroin.creabik.com/assets/img/items/item_20.png"
			        							alt="">
			        					</div>
			        				</div>
			        			</a>
			...
			<div class="call2action">
					...
					<div class="row justify-content-between align-items-center
						...
						<div class="col-md-auto">
							<img class="img-fluid img__logo"
								src="https://raroin.creabik.com/assets/img/logos/Logo_illustrstion.png"
								alt="...">
						</div>
					</div>
				</div>
					...
					<div class="row align-items-center justify-content-between">
						...
						<div class="col-lg-auto col-md-12">
							<div class="d-flex flex-column flex-md-row
								...
								<img src="https://raroin.creabik.com/assets/img/logos/1.svg" alt="">
								<img src="https://raroin.creabik.com/assets/img/logos/2.svg" alt="">
								<img src="https://raroin.creabik.com/assets/img/logos/3.svg" alt="">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-6 space-y-20">
							<div class="footer__logo">
								<a href="/">
									<img src="https://raroin.creabik.com/assets/img/logos/Logo.svg" alt="logo" id="logo_js_f">
								</a>
							</div>
						...
						<div class="col-lg-2 col-6">
							...
							<ul class="footer__list">
								<li> <a href="Dashboard1.html"> Dashboard1 </a>
								</li>
								<li> <a href="Dashboard2.html"> Dashboard2
									</a> </li>
					...
					<p class="copyright text-center">
						Copyright © 2021. I Nyoman Jyotisa.
					</p>
				</div>
			</footer>
			<script>
